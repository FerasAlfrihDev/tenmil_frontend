...
const MaintenanceSpinner: React.FC<{ size?: number; loading?: boolean }> = ({
  size = 120,
  loading = true,
}) => {
  return (
    <Modal
      ...
      centered
      fullscreen
      dialogClassName="maintenance-spinner-modal"
      backdrop="static"
      contentClassName="maintenance-spinner-content"
    >
      <Modal.Body className="maintenance-spinner-body">
        <svg
