...
const MaintenanceSpinner: React.FC<{ size?: number, loading?: boolean }> = ({ size=200, loading=true }) => {
  return (
    //TODO correct spinner size
    <Modal show={loading} size="lg" animation={true} centered={true} >
        <Modal.Body style={
          {
            display: 'flex',
